...
- Narration and recovery use reasoning `none`. The audit uses reasoning `low` as the authorized quality variant. Every call records its actual reasoning effort.
