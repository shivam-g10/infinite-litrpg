...
2. Confirm each book gets different cast names, System, class, skills, places, and opening language.
...
6. Continue one book for at least ten chapters. Check progression, dialogue, character change, active System mechanics, title variety, opening variety, and pacing.
...
- No repeated fixed Ash vocabulary unless that generated world was selected.
